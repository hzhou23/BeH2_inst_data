...
styles = {
        ...
        '2eSRTmoves'   :{'label': 'ccECP/[He] single-ref T-moves',    'color':'g', 'ecolor':'g', 'linestyle':'--', 'dashes': (3,1), 'marker':'o', 'markersize':5, 'markeredgecolor':'#000000', 'markeredgewidth':0.5},
        '2eCASnoTmoves' :{'label':'2e$^-$ ccECP 2s-2p no T-moves', 'color':'b', 'ecolor':'b', 'linestyle':'--', 'dashes': (3,1), 'marker':'^', 'markersize':5, 'markeredgecolor':'#000000', 'markeredgewidth':0.5},
}
