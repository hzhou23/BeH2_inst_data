...
styles = {
       #'2eSRnoTmoves' :{'label':'2e$^-$ ccECP single-ref no T-moves', 'color':'g', 'ecolor':'g', 'linestyle':'--', 'dashes': (3,1), 'marker':'s', 'markersize':5, 'markeredgecolor':'#000000', 'markeredgewidth':0.5},
        '2eSRTmoves'   :{'label':'ccECP/[He] single-ref T-moves',    'color':'r', 'ecolor':'r', 'linestyle':'--', 'dashes': (3,1), 'marker':'o', 'markersize':5, 'markeredgecolor':'#000000', 'markeredgewidth':0.5},
       #'2eCASnoTmoves' :{'label':'2e$^-$ ccECP 2s2p no T-moves', 'color':'b', 'ecolor':'b', 'linestyle':'--', 'dashes': (3,1), 'marker':'^', 'markersize':5, 'markeredgecolor':'#000000', 'markeredgewidth':0.5},
}
...
def init():
    ...
    legend = {'frameon':False, 'fontsize':19.0, 'handlelength':2.30, 'labelspacing':0.40, 'handletextpad':0.4, 'loc':'best'}
...
ccECP_2e_TM = pd.read_csv('C2H2_T_timestep')
...
ax1.set(ylabel= 'Energy [Ha]',xlabel='Timestep [Ha$^{-1}$]')
...
#ccECP_2e_TM = pd.read_csv('C2H2_T')
#ccECP_2e_TM = pd_s2f(ccECP_2e_TM)
#print(ccECP_2e_TM)
#
...
#ax1.errorbar(timestep, energy, yerr=errors, **styles['2eSRTmoves'])
#
#ccECP_2e_TM = pd.read_csv('C2H2_2s2p')
#ccECP_2e_TM = pd_s2f(ccECP_2e_TM)
#print(ccECP_2e_TM)
#
#timestep = ccECP_2e_TM['walltime']
...
plt.savefig('C2H2_ccECP_sr_T_timestep.pdf')
plt.show()
