...
styles = {
        '2enoTmoves' :{'label':'2e$^-$ ccECP single-ref no T-moves', 'color':'g', 'ecolor':'g', 'linestyle':'--', 'dashes': (3,1), 'marker':'s', 'markersize':5, 'markeredgecolor':'#000000', 'markeredgewidth':0.5},
        '2eTmoves'   :{'label':'2e$^-$ ccECP single-ref T-moves',    'color':'tab:orange', 'ecolor':'tab:orange', 'linestyle':'--', 'dashes': (3,1), 'marker':'o', 'markersize':5, 'markeredgecolor':'#000000', 'markeredgewidth':0.5},
        }
...
ccECP_2e_TM = pd.read_csv('aeccECPnoT.csv')
...
ax1.errorbar(timestep, energy, yerr=errors, **styles['2enoTmoves'])

ccECP_2e_TM = pd.read_csv('aeccECPTmoves.csv')
ccECP_2e_TM = pd_s2f(ccECP_2e_TM)
print(ccECP_2e_TM)
