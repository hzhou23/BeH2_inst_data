...
settings(
    pseudo_dir    = '/home/haihan/Research/BeH2/instability/qmc/001/pseudo',
    results       = '.',
    runs          = 'runs',
    status_only   = 0,
    generate_only = 0,
    sleep         = 10,      # In seconds
    machine       = 'ws8', # Use lowercase letters
...
scf = generate_pyscf(
    ...
    #job          = job(serial=True, nodes=1, queue='debug', hours=0.05, constraint='haswell', presub=scf_presub),
...
c4q = generate_convert4qmc(
    identifier   = 'c4q',
    path         = 'scf',
    #job          = job(nodes=1, queue='debug', hours=0.10, constraint='knl', presub=scf_presub),
...
gs_qmc = generate_qmcpack(
    ...
    calculations   = [ 
        ...
        dmc(targetwalkers = 2048,  # Total walkers
            timestep = 0.02,
